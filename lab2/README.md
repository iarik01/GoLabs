...
1. Написать программу, которая определяет, является ли введенное пользо- вателем число четным или нечетным.
...
5. Создать структуру Rectangle и реализовать метод для вычисления пло- щади прямоугольника.
